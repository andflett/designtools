  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-8 space-y-5">
      ...
      <Alert variant="success" size="sm">
        ...
        <AlertDescription>Consider upgrading your plan before Friday.</AlertDescription>
      </Alert>
      <Metric label="Revenue" value="$48k" unit="MRR" progress={72} variant="gradient" />
      <UserCard initials="AF" name="Andrew Flett" role="Lead Designer" status="online" size="lg" shape="circle" />
      ...
      <Table>
        ...
        <TableBody>
          ...
          <TableRow>
            ...
            <TableCell>Engineering</TableCell>
            <TableCell><Badge variant="muted" size="sm">Away</Badge></TableCell>
            <TableCell className="text-right font-mono">89</TableCell>
          </TableRow>
        </TableBody>
      </Table>
