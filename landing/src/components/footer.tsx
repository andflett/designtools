  ...
  return (
    <footer className="py-8 border-t border-edge-subtle">
      <div className="max-w-[1100px] mx-auto px-6 flex items-center justify-between">
        <span className="text-[12px] text-ink3 font-mono"><span className="text-ink3/50">@designtools/</span>surface <span className="text-ink3/30 mx-1">/</span> <a href="https://flett.cc" target="_blank" rel="noopener" className="text-ink3/50 hover:text-ink2 transition-colors">flett.cc</a></span>
